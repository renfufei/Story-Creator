...
public class TtsProviderRegistry {
    ...
    public ResolvedTtsConfig resolve(Long configId) {
        ...
        return new ResolvedTtsConfig(configId, ttsProvider, config.getModelId(), config.getBaseUrl(), config.getApiKey(), config.getExtraParams());
    }
    ...
    public record ResolvedTtsConfig(Long configId, TtsProvider provider, String modelId, String baseUrl, String apiKey, String extraParams) {}
}
