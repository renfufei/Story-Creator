...
const STEP_ORDERED_SUB_STEPS = {
    DEFAULT: {
        ...
        CHAPTER_WRITING: ['WRITING_PRIMARY', 'CHARACTER_STATES'],
        POLISHING: [],
    ...
    ENHANCED: {
        ...
        CHARACTER_DESIGN: ['CHARACTER_CARD', 'CHARACTER_OVERVIEW', 'CHARACTER_REFINE', 'BEHAVIOR_BOUNDARIES'],
        OUTLINE_GENERATION: ['VOLUME_ARC', 'CHAPTER_OUTLINE', 'CHAPTER_OUTLINE_REFINE', 'STORY_SUMMARY'],
        CHAPTER_WRITING: ['CONTEXT_BRIEFING', 'PLOT_REASONING', 'WRITING_PRIMARY', 'INSTANT_REVIEW', 'CONTENT_OPTIMIZATION', 'STORYLINE_UPDATE', 'DEEP_REVIEW', 'CHARACTER_STATES'],
        POLISHING: [],
        PROOFREADING: ['PROOFREAD_PLOT_SUMMARY', 'PROOFREAD_CHARACTER_CHECK', 'PROOFREAD_CONSISTENCY', 'PROOFREAD_CONTINUITY', 'PROOFREAD_FORESHADOWING', 'PROOFREAD_FIX'],
    },
};
