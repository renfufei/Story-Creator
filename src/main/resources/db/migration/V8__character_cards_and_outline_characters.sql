-- Add character_names column to chapter_outlines for tracking which characters appear in each chapter
ALTER TABLE chapter_outlines ADD COLUMN character_names VARCHAR(500);

-- Update CHAPTER_WRITING default template to include {{characterCards}} variable
